          ...
          <div className="media_detail_contents">
            <VideoJS
              ...
              options={{
                src: video,
                // sources: [
                //   { src: video, type: 'video/mp4', label: '1080p', default: true },
                //   { src: video, type: 'video/mp4', label: '720p' },
                //   { src: video, type: 'video/mp4', label: '480p' },
                //   { src: video, type: 'video/mp4', label: '360p' },
                //   { src: video, type: 'video/mp4', label: '240p' },
                // ],
                poster: image,
                controls: true,
                loop: false,
