    ...
    <>
      ...
      {isOpen && (
        <nav className={`drop_menu drop_menu_cloud ${isOpen && 'active'}`}>
          <ul>
            <li className="drop_menu_list icon_link" onClick={() => handleClick('/media/video/create')}>
            ...
            <li className="drop_menu_list icon_link" onClick={() => handleClick('/media/music/create')}>
            ...
            <li className="drop_menu_list icon_link" onClick={() => handleClick('/media/comic/create')}>
            ...
            <li className="drop_menu_list icon_link" onClick={() => handleClick('/media/picture/create')}>
            ...
            <li className="drop_menu_list icon_link" onClick={() => handleClick('/media/blog/create')}>
            ...
            <li className="drop_menu_list icon_link" onClick={() => handleClick('/media/chat/create')}>
