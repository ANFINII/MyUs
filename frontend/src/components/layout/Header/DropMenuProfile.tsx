...
export default function DropMenuProfile(props: Props) {
  ...
  return (
    <>
      <input type="checkbox" id="drop_menu_profile" className="d_none" />
      ...
      <nav className="drop_menu drop_menu_profile">
        <ul>
          ...
          <li className="drop_menu_list">
            <Link href="/todo" className="icon_link"></Link>
          ...
          <li className="drop_menu_list">
            <Link href={is_authenticated ? "/logout" : "/login"} className="icon_link"></Link>
