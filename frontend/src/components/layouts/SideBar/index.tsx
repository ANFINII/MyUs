  ...
  return (
    <aside className="sidebar">
      <nav className="sidebar_nav">
        ...
        <div className="sidebar_nav_2 sidebar_color">
          ...
          <Link href="/video" className="icon_link"></Link>
        </div>

        <div className="sidebar_nav_3 sidebar_color">
          ...
          <Link href="/music" className="icon_link"></Link>
        </div>

        <div className="sidebar_nav_4 sidebar_color">
          ...
          <Link href="/picture" className="icon_link"></Link>
        </div>

        <div className="sidebar_nav_5 sidebar_color">
          ...
          <Link href="/blog" className="icon_link"></Link>
        </div>

        <div className="sidebar_nav_6 sidebar_color">
          ...
          <Link href="/chat" className="icon_link"></Link>
        </div>

        <div className="sidebar_nav_7 sidebar_color">
          ...
          <p className="sidebar_text">Collabo</p>
          <Link href="/collabo" className="icon_link"></Link>
        </div>
      </nav>
    </aside>
  )
