  ...
  return (
    <aside className="sidebar">
      <nav className="sidebar_nav">
        ...
        <Link href="/video" className="sidebar_nav_2 color_sidebar">
        ...
        <Link href="/music" className="sidebar_nav_3 color_sidebar">
        ...
        <Link href="/picture" className="sidebar_nav_4 color_sidebar">
        ...
        <Link href="/blog" className="sidebar_nav_5 color_sidebar">
        ...
        <Link href="/chat" className="sidebar_nav_6 color_sidebar">
        ...
        <Link href="/collabo" className="sidebar_nav_7 color_sidebar">
