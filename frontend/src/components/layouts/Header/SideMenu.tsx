...
export default function SideMenu() {
  ...
  return (
    <>
      <input type="checkbox" id="burger_menu" className="side_menu" hidden />
      ...
      <aside className="side_menu">
        ...
        <nav>
          <div className="side_menu_item side_menu_color">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-house-door side_menu_color_bi" viewBox="0 0 16 16">
          ...
          <div className="side_menu_item side_menu_color">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-lightning-charge side_menu_color_bi" viewBox="0 0 16 16">
          ...
          <div className="side_menu_item side_menu_color">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-person-check side_menu_color_bi" viewBox="0 0 16 16">
        ...
        <footer className="side_menu_footer">
          <nav>
            <div className="side_menu_item side_menu_color">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-file-earmark-text side_menu_color_bi" viewBox="0 0 16 16">
            ...
            <div className="side_menu_item side_menu_color">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-globe side_menu_color_bi" viewBox="0 0 16 16">
            ...
            <div className="side_menu_footer_item side_menu_color">
