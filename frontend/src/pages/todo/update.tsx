  ...
  return (
    <>
      ...
      <form method="POST" action="">
        ...
        <p><input type="text" name="title" value="{{ todo.title }}" id="title" className="form-control" required/></p>

        <p><label htmlFor="content">内容</label></p>
        <p><textarea name="content" cols={100} rows={1} id="content" className="form-control textarea" required>{{ todo.content }}</textarea></p>
        ...
        <p><input type="text" name="duedate" value="{{ todo.duedate|date:'Y-m-j' }}" placeholder="2020-01-01" id="id_duedate" className="form-control" required/></p>

        <br/>

        <p><input type="submit" value="完了する" className="btn btn-success btn-sm"/></p>
      </form>
      {/* {% else %} */}
