    ...
    <>
      ...
      <article className="article_table">
        ...
        <table id="notification_table" data-csrf="{{ csrf_token }}" className="table">
          <tbody>
            <tr><td className="td_color">通知設定</td><td className="td_indent">フォローしているユーザの投稿通知などを設定</td></tr>
            <tr><td className="td_color">Video通知</td><td className="td_indent">
            ...
            <tr><td className="td_color">Music通知</td><td className="td_indent">
            ...
            <tr><td className="td_color">Blog通知</td><td className="td_indent">
            ...
            <tr><td className="td_color">フォロー通知</td><td className="td_indent">
            ...
            <tr><td className="td_color">返信通知</td><td className="td_indent">
            ...
            <tr><td className="td_color">いいね通知</td><td className="td_indent">
            ...
            <tr><td className="td_color">閲覧数通知</td><td className="td_indent">
