        ...
        <div className="header_nav_1">
          ...
          <aside className="side_menu">
            <label htmlFor="burger_menu" className="side_close color_side_menu">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-arrow-left color-side-nemu-bi" viewBox="0 0 16 16">
            ...
            <nav>
              <div className="side_menu_item color_side_menu side_indent">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-house-door color-side-nemu-bi" viewBox="0 0 16 16">
              ...
              <div className="side_menu_item color_side_menu side_indent">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-lightning-charge color-side-nemu-bi" viewBox="0 0 16 16">
              ...
              <div className="side_menu_item color_side_menu side_indent">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-person-check color-side-nemu-bi" viewBox="0 0 16 16">
            ...
            <footer className="side_footer">
              <nav>
                <div className="side_menu_item color_side_menu side_indent">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-file-earmark-text color-side-nemu-bi" viewBox="0 0 16 16">
                ...
                <div className="side_menu_item color_side_menu side_indent">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-globe color-side-nemu-bi" viewBox="0 0 16 16">
                ...
                <div className="side_menu_footer color_side_menu side_indent">
