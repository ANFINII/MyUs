      ...
      <nav className="header_nav">
        <div className="header_nav_1">
          ...
          <aside className="side_menu">
            <label htmlFor="burger_menu" className="side_close color_side_menu">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-arrow-left color_side_nemu_bi" viewBox="0 0 16 16">
            ...
            <nav>
              <div className="side_menu_item side_nemu_indent color_side_menu">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-house-door color_side_nemu_bi" viewBox="0 0 16 16">
              ...
              <div className="side_menu_item side_nemu_indent color_side_menu">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-lightning-charge color_side_nemu_bi" viewBox="0 0 16 16">
              ...
              <div className="side_menu_item side_nemu_indent color_side_menu">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-person-check color_side_nemu_bi" viewBox="0 0 16 16">
            ...
            <footer className="side_menu_footer">
              <nav>
                <div className="side_menu_item side_nemu_indent color_side_menu">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-file-earmark-text color_side_nemu_bi" viewBox="0 0 16 16">
                ...
                <div className="side_menu_item side_nemu_indent color_side_menu">
                  <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-globe color_side_nemu_bi" viewBox="0 0 16 16">
                ...
                <div className="side_menu_footer_item side_nemu_indent color_side_menu">
                  <img src="{% static 'img/MyUs.png' %}" width="24px" height="24px" className="myus_img" />
                  <div className="side_menu_footer_item">&copy; MyUs Co.,Ltd</div>
                  <Link href="/">
                    <a className="icon_link" role="button" aria-disabled="true"></a>
                  </Link>
                </div>
        ...
        <div className="header_nav_5 color_header">
          ...
          <nav className="drop_menu_cloud">
            ...
            <div className="drop_menu_item side_nemu_indent color_drop_menu">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-display color_drop_menu_bi" viewBox="0 0 16 16">
            ...
            <div className="drop_menu_item side_nemu_indent color_drop_menu">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-file-richtext color_drop_menu_bi" viewBox="0 0 16 16">
            ...
            <div className="drop_menu_item side_nemu_indent color_drop_menu">
              <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" fill="currentColor" className="bi bi-people color_drop_menu_bi" viewBox="0 0 16 16">
