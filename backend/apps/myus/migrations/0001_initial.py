# Generated by Django 3.2.5 on 2022-08-20 10:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100)),
                ('content', models.TextField()),
                ('priority', models.CharField(choices=[('danger', '高'), ('success', '普通'), ('info', '低')], default='success', max_length=10)),
                ('progress', models.CharField(choices=[('0', '未着手'), ('1', '進行中'), ('2', '完了')], default='0', max_length=10)),
                ('comment_num', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('0', '男性'), ('1', '女性'), ('2', '秘密')], default='2', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, default='abc@gmail.com', max_length=255)),
                ...
                ('plan', models.CharField(choices=[('0', 'Free'), ('1', 'Basic'), ('2', 'Standard'), ('3', 'Premium')], default='0', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('read', models.IntegerField(default=0)),
                ('type', models.CharField(choices=[('0', '全体'), ('1', '個別')], default='1', max_length=2)),
                ('period', models.DateField()),
                ('publish', models.BooleanField(default=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
