# Generated by Django 5.0 on 2024-10-19 07:10

import apps.api.utils.functions.file
import apps.myus.models.base
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='../static/img/user_icon.png', null=True, upload_to=apps.api.utils.functions.file.user_image)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=apps.api.utils.functions.file.image_upload)),
                ('video', models.FileField(upload_to=apps.api.utils.functions.file.video_upload)),
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.myus.models.base.MediaModel),
        ),
        migrations.CreateModel(
            name='ComicPage',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=apps.api.utils.functions.file.comic_upload)),
                ('sequence', models.IntegerField()),
                ('comic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comic', to='myus.comic')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('music', models.FileField(upload_to=apps.api.utils.functions.file.musics_upload)),
                ('read', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('banner', models.ImageField(blank=True, default='../static/img/MyUs_banner.png', null=True, upload_to=apps.api.utils.functions.file.user_image)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='myus.plan')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=apps.api.utils.functions.file.image_upload)),
                ('video', models.FileField(upload_to=apps.api.utils.functions.file.video_upload)),
                ('convert', models.FileField(upload_to=apps.api.utils.functions.file.video_upload)),
                ('read', models.IntegerField(default=0)),
                ('publish', models.BooleanField(default=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
