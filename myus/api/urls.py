...
from api.views.user import UserAPI, SearchTagAPI, FollowAPI, FollowerAPI, LikeMediaAPI, LikeCommentAPI, NotificationAPI
...
urlpatterns = [
    ...
    path("user/like/media", LikeMediaAPI.as_view()),
    path("user/like/comment", LikeCommentAPI.as_view()),
